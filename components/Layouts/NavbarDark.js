                                        ...
                                        <ul className="dropdown-menu mega-dropdown-menu">
                                            <li className="nav-item">
                                                ...
                                                <Link href="/software-startup" activeClassName="active">
                                                    <a className="nav-link">Software Startup <span className='new'>New</span></a>
                                                </Link>

                                                <Link href="/digital-marketing" activeClassName="active">
                                                    <a className="nav-link">Digital Marketing <span className='new'>New</span></a>
                                                </Link>

                                                <Link href="/business-consulting" activeClassName="active">
                                                    <a className="nav-link">Business Consulting <span className='new'>New</span></a>
                                                </Link>

                                                <Link href="/freelancer-portfolio" activeClassName="active">
                                                    <a className="nav-link">Freelancer Portfolio <span className='new'>New</span></a>
                                                </Link>
                                            </li>
                                            ...
                                            <li className="nav-item">
                                                ...
                                                <Link href="/app-showcase" activeClassName="active">
                                                    <a className="nav-link">App Showcase <span className='new'>New</span></a>
                                                </Link>
                                                
                                                <Link href="/personal-portfolio" activeClassName="active">
                                                    <a className="nav-link">Personal Portfolio <span className='new'>New</span></a>
                                                </Link>

                                                <Link href="/saas-startup" activeClassName="active">
                                                    <a className="nav-link">SaaS Startup <span className='new'>New</span></a>
                                                </Link>

                                                <Link href="/cyber-security-agency" activeClassName="active">
                                                    <a className="nav-link">Cyber Security Agency <span className='new'>New</span></a>
                                                </Link>
                                            </li>
                                        </ul>
                                    </li> 
