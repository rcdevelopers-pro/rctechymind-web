                    ...
                    <div className="container">
                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-4 col-md-6">
                                <div className="single-case-studies bg1" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-case-studies bg2" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                                    <div className="content">
                                        <span>
                                            <Link href="/portfolio-details">
                                                <a>Web Development</a>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-case-studies bg3" data-aos="fade-up" data-aos-duration="3000" data-aos-delay="100">
                                    <div className="content">
                                        <span>
                                            <Link href="/portfolio-details">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-case-studies bg4" data-aos="fade-up" data-aos-duration="4000" data-aos-delay="100">
                                    <div className="content">
                                        <span>
                                            <Link href="/portfolio-details">
                                                <a>App Development</a>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-case-studies bg5" data-aos="fade-up" data-aos-duration="5000" data-aos-delay="100">
                                    <div className="content">
                                        <span>
                                            <Link href="/portfolio-details">
                                                <a>Web Design</a>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-case-studies bg6" data-aos="fade-up" data-aos-duration="6000" data-aos-delay="100">
                                    <div className="content">
                                        <span>
                                            <Link href="/portfolio-details">
                                                <a>Web Development</a>
