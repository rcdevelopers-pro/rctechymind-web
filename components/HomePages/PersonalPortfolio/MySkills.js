                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="pp-skills-box">
                                    <img src="/images/personal-portfolio/skills-img1.png" alt="image" />
                                </div>
                            </div>

                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="pp-skills-box bg-eaf6ff">
                                    <img src="/images/personal-portfolio/skills-img2.png" alt="image" />
                                </div>
                            </div>

                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="pp-skills-box bg-fff5e6">
                                    <img src="/images/personal-portfolio/skills-img3.png" alt="image" />
                                </div>
                            </div>

                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="pp-skills-box bg-f0efff">
                                    <img src="/images/personal-portfolio/skills-img4.png" alt="image" />
                                </div>
                            </div>
                        </div>
                    </div>
