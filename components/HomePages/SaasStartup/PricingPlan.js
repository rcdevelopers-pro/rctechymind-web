                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-lg-4 col-md-6 col-sm-6">
                                            <div className="saas-pricing-box bg-black saas-color">
                                                <div className="pricing-header">
                                                    <h3>Starter</h3>
                                                    <span className="price">$29<span>/month</span></span>
                                                </div>
                                        ...
                                        <div className="col-lg-4 col-md-6 col-sm-6">
                                            <div className="saas-pricing-box active bg-black saas-color">
                                                <div className="pricing-header">
                                                    <h3>Professional</h3>
                                                    <span className="price">$39<span>/month</span></span>
                                                </div>
                                                <ul className="features-list">
                                        ...
                                        <div className="col-lg-4 col-md-6 col-sm-6">
                                            <div className="saas-pricing-box bg-black saas-color">
                                                <div className="pricing-header">
                                                    <h3>Premium</h3>
                                                    <span className="price">$49<span>/month</span></span>
                                                </div>
                                                <ul className="features-list">
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-lg-4 col-md-6 col-sm-6">
                                            <div className="saas-pricing-box bg-black saas-color">
                                                <div className="pricing-header">
                                                    <h3>Starter</h3>
                                                    <span className="price">$59<span>/year</span></span>
                                                </div>
                                                <ul className="features-list">
                                                    <li>7 Days Free Trail</li>
                                                    <li>App-In-Purchase</li>
                                        ...
                                        <div className="col-lg-4 col-md-6 col-sm-6">
                                            <div className="saas-pricing-box active bg-black saas-color">
                                                <div className="pricing-header">
                                                    <h3>Professional</h3>
                                                    <span className="price">$79<span>/year</span></span>
                                                </div>
                                                <ul className="features-list">
                                                    <li>One Time Purchase</li>
                                                    <li>App-In-Purchase</li>
                                        ...
                                        <div className="col-lg-4 col-md-6 col-sm-6">
                                            <div className="saas-pricing-box bg-black saas-color">
                                                <div className="pricing-header">
                                                    <h3>Premium</h3>
                                                    <span className="price">$99<span>/year</span></span>
                                                </div>
                                                <ul className="features-list">
                                                    <li>Unlimited Purchase</li>
                                                    <li>App-In-Purchase</li>
