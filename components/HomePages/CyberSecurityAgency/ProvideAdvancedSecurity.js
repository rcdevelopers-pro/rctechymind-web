...
export default class ProvideAdvancedSecurity extends Component {
  render() {
    return (
      <>
        <div className="leading-technology-area pb-100">
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-12">
                <div className="leading-technology-image">
                  <img
                    src="/images/cyber-security/leading-technology.png"
                    alt="image"
                  />
                </div>
              </div>
