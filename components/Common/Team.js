                ...
                <div className="pt-100 pb-70">
                    <div className="container">
                        ...
                        <div className="row justify-content-center">
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="team-card text-center" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                                    <img 
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="team-card text-center" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
                                    <img 
